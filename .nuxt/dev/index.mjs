...
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://C:/Users/User/Desktop/users/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://C:/Users/User/Desktop/users/node_modules/devalue/index.js';
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file://C:/Users/User/Desktop/users/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file://C:/Users/User/Desktop/users/node_modules/vue/server-renderer/index.mjs';
import { renderSSRHead } from 'file://C:/Users/User/Desktop/users/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file://C:/Users/User/Desktop/users/node_modules/ofetch/dist/node.mjs';
import destr from 'file://C:/Users/User/Desktop/users/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file://C:/Users/User/Desktop/users/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://C:/Users/User/Desktop/users/node_modules/hookable/dist/index.mjs';
import { klona } from 'file://C:/Users/User/Desktop/users/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file://C:/Users/User/Desktop/users/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file://C:/Users/User/Desktop/users/node_modules/defu/dist/defu.mjs';
import { hash } from 'file://C:/Users/User/Desktop/users/node_modules/ohash/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://C:/Users/User/Desktop/users/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://C:/Users/User/Desktop/users/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://C:/Users/User/Desktop/users/node_modules/radix3/dist/index.mjs';
import { version, unref } from 'file://C:/Users/User/Desktop/users/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file://C:/Users/User/Desktop/users/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file://C:/Users/User/Desktop/users/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"C:/Users/User/Desktop/users/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Users\\User\\Desktop\\users","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Users\\User\\Desktop\\users\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Users\\User\\Desktop\\users\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Users\\User\\Desktop\\users\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"C:\\Users\\User\\Desktop\\users\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _lazy_YHbSDb = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_YHbSDb, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_YHbSDb, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file://C:/Users/User/Desktop/users/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://C:/Users/User/Desktop/users/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
